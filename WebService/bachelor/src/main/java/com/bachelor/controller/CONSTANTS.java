...
public class CONSTANTS {
	...
	protected static final String getImageSummary = "Get image by its Id from the database";
	protected static final String updateStatusSummary = "Update an image and move it from the temporary directory to its final destination based on its predicted status ";
